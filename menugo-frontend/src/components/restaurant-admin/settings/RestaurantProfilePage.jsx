...
const RestaurantProfilePage = () => {
  ...
  return (
    <div className="p-6 bg-white text-slate-900 font-['Manrope',system-ui,sans-serif] min-h-full">
      <div className="mb-6">
      ...
      <div className="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm overflow-y-auto">
