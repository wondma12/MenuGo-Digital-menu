  ...
  return (
    <div className="min-h-screen bg-white text-slate-900">
          ...
          <motion.div variants={staggerContainer} initial="hidden" whileInView="show" viewport={{ once: true }}>
            <motion.div variants={fadeInDown} className="mx-auto max-w-3xl text-center">
              ...
              <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
                <a href="/contact" className="inline-flex items-center gap-2 rounded-xl bg-orange-600 px-5 py-2.5 text-sm font-semibold text-white shadow-lg shadow-orange-600/30 transition-all hover:-translate-y-0.5 hover:bg-orange-700">
                  Contact Us
                  <ArrowRightIcon className="h-4 w-4" />
                </a>
                <a href="/services" className="inline-flex items-center rounded-xl border border-slate-200 bg-white/80 px-5 py-2.5 text-sm font-semibold text-slate-700 transition-all hover:-translate-y-0.5 hover:border-orange-300 hover:text-orange-600">
                  See Services
                </a>
              </div>
            </motion.div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 gap-4 md:grid-cols-4 md:gap-6">
            {metrics.map((item, index) => (
              ...
              >
                <p className="text-2xl font-extrabold text-orange-600 sm:text-3xl">{item.value}</p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-12">
            <motion.div variants={fadeInUp} initial="hidden" whileInView="show" viewport={{ once: true }}>
              ...
              <h2 className="mt-3 text-2xl font-black tracking-tight text-slate-900 md:text-3xl">Built from real restaurant pain points</h2>
              ...
              <div className="mt-6 space-y-3">
                {milestones.map((item, idx) => (
                  <motion.div
                    ...
                    className="flex gap-3 rounded-2xl border border-slate-100 bg-white p-3 shadow-sm hover:shadow-md transition-all"
                  >
      ...
      <section className="bg-gradient-to-br from-slate-50 to-white py-14 sm:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto mb-10 max-w-3xl text-center">
            <h2 className="text-2xl font-black tracking-tight text-slate-900 md:text-3xl">Mission and vision</h2>
            <p className="mt-2 text-sm text-slate-600">A focused product direction built around practical improvements for hospitality teams.</p>
          </div>

          <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
            <motion.div variants={subtleFloat} initial="hidden" whileInView="show" viewport={{ once: true }} className="group rounded-3xl border border-slate-200 bg-white p-6 shadow-sm transition-all hover:shadow-lg">
              <RocketLaunchIcon className="mb-3 h-12 w-12 text-orange-600" />
              <h3 className="mb-2 text-xl font-bold text-slate-900">Our Mission</h3>
              <p className="text-sm leading-relaxed text-slate-600">To empower restaurants with digital tools that reduce friction, improve guest experience, and increase operational confidence.</p>
            </motion.div>

            <motion.div variants={subtleFloat} initial="hidden" whileInView="show" transition={{ delay: 0.12 }} viewport={{ once: true }} className="group rounded-3xl border border-slate-200 bg-white p-6 shadow-sm transition-all hover:shadow-lg">
              <GlobeAltIcon className="mb-3 h-12 w-12 text-orange-600" />
              <h3 className="mb-2 text-xl font-bold text-slate-900">Our Vision</h3>
              <p className="text-sm leading-relaxed text-slate-600">To become a trusted restaurant operating platform that scales from independent venues to multi-location businesses.</p>
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white py-14 sm:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto mb-10 max-w-3xl text-center">
            <h2 className="text-2xl font-black tracking-tight text-slate-900 md:text-3xl">What we value</h2>
            <p className="mt-2 text-sm text-slate-600">These principles shape every product decision and customer interaction.</p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {values.map((value, index) => (
              ...
              >
                ...
                <h3 className="mb-1.5 text-lg font-bold text-slate-900">{value.title}</h3>
      ...
      <section className="bg-orange-50 py-14 sm:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto mb-8 max-w-3xl text-center">
            <h2 className="text-2xl font-black tracking-tight text-slate-900 md:text-3xl">Real impact, measured</h2>
            <p className="mt-2 text-sm text-slate-700">Numbers from restaurants using MenuGo every day.</p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
            {impactStats.map((stat, idx) => (
              ...
              >
                <stat.icon className="mx-auto h-7 w-7 text-orange-600" />
      ...
      <section className="bg-white py-14 sm:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto mb-10 max-w-3xl text-center">
            <h2 className="text-2xl font-black tracking-tight text-slate-900 md:text-3xl">Stories from our community</h2>
            <p className="mt-2 text-sm text-slate-600">Real restaurant leaders share their experience with MenuGo.</p>
          </div>
            ...
            {teamStories.map((story, idx) => (
              ...
              >
                ...
                <div className="mt-3 flex items-center gap-3">
                  <img src={story.avatar} alt={story.name} className="h-9 w-9 rounded-full object-cover ring-2 ring-orange-200" />
                  <div>
      ...
      <section className="bg-slate-50 py-14 sm:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto mb-10 max-w-3xl text-center">
            <h2 className="text-2xl font-black tracking-tight text-slate-900 md:text-3xl">How our team thinks</h2>
            <p className="mt-2 text-sm text-slate-600">We ship with a product-first mindset and build around the realities of restaurant operations.</p>
          </div>
      ...
      <section className="relative overflow-hidden bg-slate-900 py-14 sm:py-16">
        ...
        <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <motion.div variants={popIn} className="mt-6 flex flex-wrap items-center justify-center gap-3">
            <a href="/contact" className="inline-flex items-center gap-2 rounded-xl bg-orange-500 px-6 py-2.5 text-sm font-semibold text-slate-900 transition-all hover:-translate-y-0.5 hover:bg-orange-400">
              Get in Touch
              <ArrowRightIcon className="h-4 w-4" />
            </a>
            <a href="/services" className="inline-flex items-center rounded-xl border border-slate-600 px-6 py-2.5 text-sm font-semibold text-white transition-all hover:-translate-y-0.5 hover:border-slate-400 hover:text-white">
              View Services
            </a>
          </motion.div>
        </div>
